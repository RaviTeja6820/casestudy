...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nvar elements = exports.elements = {\n    top10form: document.getElementById('top10'),\n    top10dis: document.querySelector('.list__top10'),\n    header: document.querySelector('.header'),\n    signup: document.getElementById('info'),\n    navbar: document.getElementById('nav__signup'),\n    username: document.getElementById('form-un'),\n    psswd: document.getElementById('form-pa'),\n    signout: document.getElementById('signout'),\n    list: document.querySelector('.list'),\n    likeList: document.getElementById('likeList'),\n    bookmarkList: document.getElementById('bookmarkList'),\n    searchbar: document.getElementById('search'),\n    filterYear: document.getElementById('year'),\n    filterType: document.getElementById('type'),\n    filterRating: document.getElementById('rating'),\n    searchbtn: document.querySelector('.search-btn'),\n    movieDet: document.getElementById('movie-det')\n};\n\n//# sourceURL=webpack:///./src/js/base.js?");
...
"use strict";
eval("\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/base.js\");\n\nvar _top = __webpack_require__(/*! ./models/top10 */ \"./src/js/models/top10.js\");\n\nvar _top2 = _interopRequireDefault(_top);\n\nvar _signinnup = __webpack_require__(/*! ./models/signinnup */ \"./src/js/models/signinnup.js\");\n\nvar _signinnup2 = _interopRequireDefault(_signinnup);\n\nvar _booknlike = __webpack_require__(/*! ./models/booknlike */ \"./src/js/models/booknlike.js\");\n\nvar _booknlike2 = _interopRequireDefault(_booknlike);\n\nvar _search = __webpack_require__(/*! ./models/search */ \"./src/js/models/search.js\");\n\nvar _search2 = _interopRequireDefault(_search);\n\nvar _top10view = __webpack_require__(/*! ./views/top10view */ \"./src/js/views/top10view.js\");\n\nvar top10View = _interopRequireWildcard(_top10view);\n\nvar _signupView = __webpack_require__(/*! ./views/signupView */ \"./src/js/views/signupView.js\");\n\nvar _booknlikeView = __webpack_require__(/*! ./views/booknlikeView */ \"./src/js/views/booknlikeView.js\");\n\nvar booknlikeView = _interopRequireWildcard(_booknlikeView);\n\nvar _searchView = __webpack_require__(/*! ./views/searchView */ \"./src/js/views/searchView.js\");\n\nvar searchView = _interopRequireWildcard(_searchView);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar state = [];\nlocalStorage.setItem('login', false);\nconsole.log(state);\nvar controlTop = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n            while (1) {\n                switch (_context.prev = _context.next) {\n                    case 0:\n                        //create top 10 list\n                        state.top = new _top2.default();\n                        //retrive data from server\n                        top10View.clearResults();\n                        _context.prev = 2;\n                        _context.next = 5;\n                        return state.top.getTop10();\n\n                    case 5:\n                        _context.next = 10;\n                        break;\n\n                    case 7:\n                        _context.prev = 7;\n                        _context.t0 = _context['catch'](2);\n\n                        alert(_context.t0);\n\n                    case 10:\n                    case 'end':\n                        return _context.stop();\n                }\n            }\n        }, _callee, undefined, [[2, 7]]);\n    }));\n\n    return function controlTop() {\n        return _ref.apply(this, arguments);\n    };\n}();\n\n_base.elements.top10form.addEventListener('click', function (e) {\n    e.preventDefault();\n    controlTop();\n    _base.elements.top10dis.scrollIntoView();\n});\n\n_base.elements.top10dis.addEventListener('click', function (e) {\n    if (e.target.matches('#top10Close')) {\n        e.preventDefault();\n        // const res = state.top.getDetails();\n        // console.log(res);\n        // console.log(res.length);\n        top10View.clearResults();\n    }\n});\n\nwindow.addEventListener('load', function () {\n    state.signinnup = new _signinnup2.default();\n    state.signinnup.readStorage();\n});\n\nvar login = false;\n\nif (_base.elements.header) _base.elements.header.addEventListener('click', function (el) {\n    if (el.target.matches('#info')) {\n        if (!document.getElementById('form-rpa')) (0, _signupView.signupView)();\n    } else if (el.target.matches('.signin') || el.target.closest('.signin p')) {\n        el.preventDefault();\n        if (!document.getElementById('form-rpa')) {\n            var name = _base.elements.username.value;\n            var pass = _base.elements.psswd.value;\n            var user = {\n                username: name,\n                password: pass\n            };\n            if (name.length === 0 || pass.length === 0) {\n                alert(' * fields are empty ');\n            } else {\n                state.signinnup.signinCheck(user);\n            }\n        }\n    } else if (el.target.matches('.signup') || el.target.closest('.signup p')) {\n        el.preventDefault();\n        if (!document.getElementById('form-rpa')) {\n            alert('click \\'@new user\\' or \\'SignUp button\\' at top right corner to create an account');\n        } else {\n            var _name = _base.elements.username.value;\n            var _pass = _base.elements.psswd.value;\n            var repass = document.getElementById('form-rpa').value;\n            if (_name.length === 0 || _pass.length === 0 || repass.length === 0) {\n                alert(' * fields are empty ');\n            } else if (state.signinnup.passCheck(_pass)) {\n                if (_pass !== repass) alert('wrong entry in renter password');else {\n                    if (!state.signinnup.signup(_name, _pass)) alert('User already exists');\n                }\n            } else alert('password doesn\\'t follow required credentials');;\n        }\n    }\n});\n\nif (_base.elements.signout) _base.elements.signout.addEventListener('click', function (el) {\n    el.preventDefault();\n    window.location = \"/\";\n    var url = window.location.href;\n    var rep = url.substr(21, url.length);\n    url = url.replace(rep, \"\");\n    localStorage.setItem('login', false);\n    localStorage.setItem('log', '');\n    window.location.href = url;\n});\n\nvar controlLikes = function () {\n    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(el) {\n        var movie;\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n            while (1) {\n                switch (_context2.prev = _context2.next) {\n                    case 0:\n                        _context2.next = 2;\n                        return state.signedin.getData(el);\n\n                    case 2:\n                        movie = _context2.sent;\n\n                        // console.log(movie);\n                        booknlikeView.renderLikes(movie);\n\n                    case 4:\n                    case 'end':\n                        return _context2.stop();\n                }\n            }\n        }, _callee2, undefined);\n    }));\n\n    return function controlLikes(_x) {\n        return _ref2.apply(this, arguments);\n    };\n}();\n\nvar controlBookmarks = function () {\n    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(el) {\n        var movie;\n        return regeneratorRuntime.wrap(function _callee3$(_context3) {\n            while (1) {\n                switch (_context3.prev = _context3.next) {\n                    case 0:\n                        _context3.next = 2;\n                        return state.signedin.getData(el);\n\n                    case 2:\n                        movie = _context3.sent;\n\n                        // console.log(movie);\n                        booknlikeView.renderBookmarks(movie);\n\n                    case 4:\n                    case 'end':\n                        return _context3.stop();\n                }\n            }\n        }, _callee3, undefined);\n    }));\n\n    return function controlBookmarks(_x2) {\n        return _ref3.apply(this, arguments);\n    };\n}();\n\nif (!_base.elements.header) {\n    // let url = window.location.href;\n    // const username = (url.substr(36,url.length));\n    var username = localStorage.getItem('log');\n    state.signedin = new _booknlike2.default(username);\n    state.signedin.readStorage();\n    localStorage.setItem('login', true);\n    var likes = state.signedin.getLikes();\n    likes.forEach(function () {\n        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(el) {\n            return regeneratorRuntime.wrap(function _callee4$(_context4) {\n                while (1) {\n                    switch (_context4.prev = _context4.next) {\n                        case 0:\n                            _context4.next = 2;\n                            return controlLikes(el);\n\n                        case 2:\n                        case 'end':\n                            return _context4.stop();\n                    }\n                }\n            }, _callee4, undefined);\n        }));\n\n        return function (_x3) {\n            return _ref4.apply(this, arguments);\n        };\n    }());\n    var bookmarks = state.signedin.getBookmarks();\n    bookmarks.forEach(function () {\n        var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(el) {\n            return regeneratorRuntime.wrap(function _callee5$(_context5) {\n                while (1) {\n                    switch (_context5.prev = _context5.next) {\n                        case 0:\n                            _context5.next = 2;\n                            return controlBookmarks(el);\n\n                        case 2:\n                        case 'end':\n                            return _context5.stop();\n                    }\n                }\n            }, _callee5, undefined);\n        }));\n\n        return function (_x4) {\n            return _ref5.apply(this, arguments);\n        };\n    }());\n    searchView.addYearFilter();\n};\n\nif (_base.elements.navbar) _base.elements.navbar.addEventListener('click', function () {\n    if (!document.getElementById('form-rpa')) {\n        (0, _signupView.signupView)();\n    }\n});\n\nif (_base.elements.list) _base.elements.list.addEventListener('click', function (e) {\n    e.preventDefault();\n    // console.log(localStorage.getItem('login'));\n    // console.log(e.target);\n    if (e.target.matches('.far') && e.target.matches('.fa-heart')) {\n        var str = e.target.className;\n        str = str.replace('far', 'fas');\n        e.target.className = str;\n        var movieId = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.id;\n        //addlike\n        state.signedin.addLike(movieId);\n        controlLikes(movieId);\n    } else if (e.target.matches('.far') && e.target.matches('.fa-bookmark')) {\n        // console.log(e.target + ' ' + 2);\n        var _str = e.target.className;\n        _str = _str.replace('far', 'fas');\n        e.target.className = _str;\n        var _movieId = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.id;\n        //add bookmark\n        state.signedin.addBookmark(_movieId);\n        controlBookmarks(_movieId);\n    } else if (e.target.matches('.fas') && e.target.matches('.fa-heart')) {\n        // console.log(e.target + ' ' + 3);\n        var _str2 = e.target.className;\n        _str2 = _str2.replace('fas', 'far');\n        e.target.className = _str2;\n        var _movieId2 = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.id;\n        //remove like\n        state.signedin.deleteLike(_movieId2);\n        booknlikeView.deleteLike(_movieId2);\n    } else if (e.target.matches('.fas') && e.target.matches('.fa-bookmark')) {\n        // console.log(e.target + ' ' + 4);\n        var _str3 = e.target.className;\n        _str3 = _str3.replace('fas', 'far');\n        e.target.className = _str3;\n        var _movieId3 = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.id;\n        //remove bookmark\n        state.signedin.deleteBookmark(_movieId3);\n        booknlikeView.deleteBookmark(_movieId3);\n    } else if (e.target.matches('.movie__img')) {\n        var find = function () {\n            var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {\n                var movieID, movieDetails;\n                return regeneratorRuntime.wrap(function _callee6$(_context6) {\n                    while (1) {\n                        switch (_context6.prev = _context6.next) {\n                            case 0:\n                                movieID = e.target.parentNode.parentNode.parentNode.id;\n\n                                state.search = new _search2.default('');\n                                _context6.next = 4;\n                                return state.search.getMovieDetailsById(movieID);\n\n                            case 4:\n                                movieDetails = _context6.sent;\n\n                                searchView.clearMovie();\n                                searchView.renderMovieSearch(movieDetails);\n                                _base.elements.movieDet.scrollIntoView();\n\n                            case 8:\n                            case 'end':\n                                return _context6.stop();\n                        }\n                    }\n                }, _callee6, undefined);\n            }));\n\n            return function find() {\n                return _ref6.apply(this, arguments);\n            };\n        }();\n        find();\n    }\n});\n\nif (_base.elements.list) _base.elements.top10dis.addEventListener('click', function (e) {\n    e.preventDefault();\n    // console.log(localStorage.getItem('login'));\n    // console.log(e.target);\n    if (e.target.matches('.far') && e.target.matches('.fa-heart')) {\n        var str = e.target.className;\n        str = str.replace('far', 'fas');\n        e.target.className = str;\n        var movieId = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.id;\n        //addlike\n        state.signedin.addLike(movieId);\n        controlLikes(movieId);\n    } else if (e.target.matches('.far') && e.target.matches('.fa-bookmark')) {\n        // console.log(e.target + ' ' + 2);\n        var _str4 = e.target.className;\n        _str4 = _str4.replace('far', 'fas');\n        e.target.className = _str4;\n        var _movieId4 = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.id;\n        //add bookmark\n        state.signedin.addBookmark(_movieId4);\n        controlBookmarks(_movieId4);\n    } else if (e.target.matches('.fas') && e.target.matches('.fa-heart')) {\n        // console.log(e.target + ' ' + 3);\n        var _str5 = e.target.className;\n        _str5 = _str5.replace('fas', 'far');\n        e.target.className = _str5;\n        var _movieId5 = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.id;\n        //remove like\n        state.signedin.deleteLike(_movieId5);\n        booknlikeView.deleteLike(_movieId5);\n    } else if (e.target.matches('.fas') && e.target.matches('.fa-bookmark')) {\n        // console.log(e.target + ' ' + 4);\n        var _str6 = e.target.className;\n        _str6 = _str6.replace('fas', 'far');\n        e.target.className = _str6;\n        var _movieId6 = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.id;\n        //remove bookmark\n        state.signedin.deleteBookmark(_movieId6);\n        booknlikeView.deleteBookmark(_movieId6);\n    } else if (e.target.matches('.movie__img')) {\n        var find = function () {\n            var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {\n                var movieID, movieDetails;\n                return regeneratorRuntime.wrap(function _callee7$(_context7) {\n                    while (1) {\n                        switch (_context7.prev = _context7.next) {\n                            case 0:\n                                movieID = e.target.parentNode.parentNode.parentNode.id;\n\n                                state.search = new _search2.default('');\n                                _context7.next = 4;\n                                return state.search.getMovieDetailsById(movieID);\n\n                            case 4:\n                                movieDetails = _context7.sent;\n\n                                searchView.clearMovie();\n                                searchView.renderMovieSearch(movieDetails);\n                                _base.elements.movieDet.scrollIntoView();\n\n                            case 8:\n                            case 'end':\n                                return _context7.stop();\n                        }\n                    }\n                }, _callee7, undefined);\n            }));\n\n            return function find() {\n                return _ref7.apply(this, arguments);\n            };\n        }();\n        find();\n    }\n});\n\nif (_base.elements.searchbar) {\n    _base.elements.searchbtn.addEventListener('click', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {\n        var movie, ratings, year, movieSearch, markup;\n        return regeneratorRuntime.wrap(function _callee8$(_context8) {\n            while (1) {\n                switch (_context8.prev = _context8.next) {\n                    case 0:\n                        _context8.next = 2;\n                        return _base.elements.searchbar.value;\n\n                    case 2:\n                        movie = _context8.sent;\n                        _context8.next = 5;\n                        return _base.elements.filterRating.value;\n\n                    case 5:\n                        ratings = _context8.sent;\n                        _context8.next = 8;\n                        return _base.elements.filterYear.value;\n\n                    case 8:\n                        year = _context8.sent;\n\n                        // const type = await elements.filterType.value;\n                        state.search = new _search2.default(movie);\n                        _context8.next = 12;\n                        return state.search.getMovieDetailsByFilters(year);\n\n                    case 12:\n                        movieSearch = _context8.sent;\n\n                        // console.log(movieSearch.Response);\n                        if (movieSearch.Response === \"False\") {\n                            markup = '<h1 style=\"font-size: 70%;text-align: center; margin-top: 3%; background: #aaa; color: black;\">No Such Movie Found</h1>';\n\n                            _base.elements.movieDet.insertAdjacentHTML('afterbegin', markup);\n                        } else {\n                            searchView.renderMovies(movieSearch, ratings);\n                            _base.elements.list.scrollIntoView();\n                        }\n                        // console.log(movieDetails);\n\n                    case 14:\n                    case 'end':\n                        return _context8.stop();\n                }\n            }\n        }, _callee8, undefined);\n    })));\n    document.addEventListener('keypress', function (e) {\n        if (e.keyCode === 13 || e.keyCode === 13) {\n            var get = function () {\n                var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {\n                    var movie, ratings, year, movieSearch, markup;\n                    return regeneratorRuntime.wrap(function _callee9$(_context9) {\n                        while (1) {\n                            switch (_context9.prev = _context9.next) {\n                                case 0:\n                                    _context9.next = 2;\n                                    return _base.elements.searchbar.value;\n\n                                case 2:\n                                    movie = _context9.sent;\n                                    _context9.next = 5;\n                                    return _base.elements.filterRating.value;\n\n                                case 5:\n                                    ratings = _context9.sent;\n                                    _context9.next = 8;\n                                    return _base.elements.filterYear.value;\n\n                                case 8:\n                                    year = _context9.sent;\n\n                                    // const type = await elements.filterType.value;\n                                    state.search = new _search2.default(movie);\n                                    _context9.next = 12;\n                                    return state.search.getMovieDetailsByFilters(year);\n\n                                case 12:\n                                    movieSearch = _context9.sent;\n\n                                    // console.log(movieSearch.Response);\n                                    if (movieSearch.Response === \"False\") {\n                                        markup = '<h1 style=\"font-size: 70%;text-align: center; margin-top: 3%; background: #aaa; color: black;\">No Such Movie Found</h1>';\n\n                                        _base.elements.movieDet.insertAdjacentHTML('afterbegin', markup);\n                                    } else {\n                                        searchView.renderMovies(movieSearch, ratings);\n                                        _base.elements.list.scrollIntoView();\n                                    }\n\n                                case 14:\n                                case 'end':\n                                    return _context9.stop();\n                            }\n                        }\n                    }, _callee9, undefined);\n                }));\n\n                return function get() {\n                    return _ref9.apply(this, arguments);\n                };\n            }();\n            get();\n        }\n    });\n}\n\nif (_base.elements.movieDet) _base.elements.movieDet.addEventListener('click', function (e) {\n    e.preventDefault();\n    if (e.target.matches('.far') && e.target.matches('.fa-heart')) {\n        var str = e.target.className;\n        str = str.replace('far', 'fas');\n        e.target.className = str;\n        var movieId = e.target.parentNode.parentNode.parentNode.parentNode.id;\n        movieId = movieId.replace('#', '');\n        // console.log(movieId);\n        state.signedin.addLike(movieId);\n        controlLikes(movieId);\n    } else if (e.target.matches('.far') && e.target.matches('.fa-bookmark')) {\n        // console.log(e.target + ' ' + 2);\n        var _str7 = e.target.className;\n        _str7 = _str7.replace('far', 'fas');\n        e.target.className = _str7;\n        var _movieId7 = e.target.parentNode.parentNode.parentNode.parentNode.id;\n        _movieId7 = _movieId7.replace('#', '');\n        //add bookmark\n        state.signedin.addBookmark(_movieId7);\n        controlBookmarks(_movieId7);\n    } else if (e.target.matches('.fas') && e.target.matches('.fa-heart')) {\n        // console.log(e.target + ' ' + 3);\n        var _str8 = e.target.className;\n        _str8 = _str8.replace('fas', 'far');\n        e.target.className = _str8;\n        var _movieId8 = e.target.parentNode.parentNode.parentNode.parentNode.id;\n        _movieId8 = _movieId8.replace('#', '');\n        //remove like\n        state.signedin.deleteLike(_movieId8);\n        booknlikeView.deleteLike(_movieId8);\n    } else if (e.target.matches('.fas') && e.target.matches('.fa-bookmark')) {\n        // console.log(e.target + ' ' + 4);\n        var _str9 = e.target.className;\n        _str9 = _str9.replace('fas', 'far');\n        e.target.className = _str9;\n        var _movieId9 = e.target.parentNode.parentNode.parentNode.parentNode.id;\n        _movieId9 = _movieId9.replace('#', '');\n        //remove bookmark\n        state.signedin.deleteBookmark(_movieId9);\n        booknlikeView.deleteBookmark(_movieId9);\n    }\n});\n\nif (_base.elements.likeList) _base.elements.likeList.addEventListener('click', function () {\n    var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(e) {\n        var address, startInd, movieId, movieDetails;\n        return regeneratorRuntime.wrap(function _callee10$(_context10) {\n            while (1) {\n                switch (_context10.prev = _context10.next) {\n                    case 0:\n                        address = e.target.parentNode.parentNode.href;\n                        startInd = address.indexOf(\"#\");\n                        movieId = address.slice(startInd + 1, address.length);\n                        // console.log(movieId);\n\n                        state.search = new _search2.default('');\n                        _context10.next = 6;\n                        return state.search.getMovieDetailsById(movieId);\n\n                    case 6:\n                        movieDetails = _context10.sent;\n\n                        searchView.clearMovie();\n                        searchView.renderMovieSearch(movieDetails);\n                        _base.elements.movieDet.scrollIntoView();\n\n                    case 10:\n                    case 'end':\n                        return _context10.stop();\n                }\n            }\n        }, _callee10, undefined);\n    }));\n\n    return function (_x5) {\n        return _ref10.apply(this, arguments);\n    };\n}());\n\nif (_base.elements.bookmarkList) _base.elements.bookmarkList.addEventListener('click', function () {\n    var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(e) {\n        var address, startInd, movieId, movieDetails;\n        return regeneratorRuntime.wrap(function _callee11$(_context11) {\n            while (1) {\n                switch (_context11.prev = _context11.next) {\n                    case 0:\n                        address = e.target.parentNode.parentNode.href;\n                        startInd = address.indexOf(\"#\");\n                        movieId = address.slice(startInd + 1, address.length);\n                        // console.log(movieId);\n\n                        state.search = new _search2.default('');\n                        _context11.next = 6;\n                        return state.search.getMovieDetailsById(movieId);\n\n                    case 6:\n                        movieDetails = _context11.sent;\n\n                        searchView.clearMovie();\n                        searchView.renderMovieSearch(movieDetails);\n                        _base.elements.movieDet.scrollIntoView();\n\n                    case 10:\n                    case 'end':\n                        return _context11.stop();\n                }\n            }\n        }, _callee11, undefined);\n    }));\n\n    return function (_x6) {\n        return _ref11.apply(this, arguments);\n    };\n}());\n\n//# sourceURL=webpack:///./src/js/index.js?");

/***/ }),

/***/ "./src/js/models/booknlike.js":
/*!************************************!*\
  !*** ./src/js/models/booknlike.js ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _booknlikeView = __webpack_require__(/*! ../views/booknlikeView */ \"./src/js/views/booknlikeView.js\");\n\nvar _booknlikeView2 = _interopRequireDefault(_booknlikeView);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar booknlike = function () {\n    function booknlike(username) {\n        _classCallCheck(this, booknlike);\n\n        this.userDetails = [];\n        this.username = username;\n        this.likes = [];\n        this.bookmarks = [];\n    }\n\n    _createClass(booknlike, [{\n        key: 'addLike',\n        value: function addLike(id) {\n            if (this.likes.indexOf(id) === -1) this.likes.push(id);\n            this.persistData();\n        }\n    }, {\n        key: 'addBookmark',\n        value: function addBookmark(id) {\n            if (this.bookmarks.indexOf(id) === -1) this.bookmarks.push(id);\n            this.persistData();\n        }\n    }, {\n        key: 'deleteLike',\n        value: function deleteLike(id) {\n            var index = this.likes.findIndex(function (el) {\n                return el === id;\n            });\n            this.likes.splice(index, 1);\n            this.persistData();\n        }\n    }, {\n        key: 'deleteBookmark',\n        value: function deleteBookmark(id) {\n            var index = this.likes.findIndex(function (el) {\n                return el === id;\n            });\n            this.bookmarks.splice(index, 1);\n            this.persistData();\n        }\n    }, {\n        key: 'isLiked',\n        value: function isLiked(id) {\n            if (this.likes.findIndex(function (el) {\n                return el === id;\n            }) >= 0) {\n                return true;\n            } else return false;\n        }\n    }, {\n        key: 'isBookmarked',\n        value: function isBookmarked(id) {\n            if (this.bookmarks.findIndex(function (el) {\n                return el === id;\n            }) >= 0) {\n                return true;\n            } else return false;\n        }\n    }, {\n        key: 'getUserName',\n        value: function getUserName() {\n            return this.username;\n        }\n    }, {\n        key: 'getLikes',\n        value: function getLikes() {\n            return this.likes;\n        }\n    }, {\n        key: 'getBookmarks',\n        value: function getBookmarks() {\n            return this.bookmarks;\n        }\n    }, {\n        key: 'addUserDetail',\n        value: function addUserDetail() {\n            var userDetail = {\n                username: this.username,\n                likes: this.likes,\n                bookmarks: this.bookmarks\n            };\n\n            if (this.userDetails.findIndex(function (el) {\n                return el.username === userDetail.username;\n            }) === -1) {\n                this.userDetails.push(userDetail);\n            }\n        }\n    }, {\n        key: 'getData',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(movieID) {\n                var res, movie;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.prev = 0;\n                                _context.next = 3;\n                                return (0, _axios2.default)('http://www.omdbapi.com/?i=' + movieID + '&apikey=dbaf7dd7');\n\n                            case 3:\n                                res = _context.sent;\n\n                                // console.log(res);\n                                movie = {\n                                    poster: res.data.Poster,\n                                    title: res.data.Title,\n                                    id: res.data.imdbID,\n                                    director: res.data.Director,\n                                    boxoffice: res.data.BoxOffice\n                                };\n                                return _context.abrupt('return', movie);\n\n                            case 8:\n                                _context.prev = 8;\n                                _context.t0 = _context['catch'](0);\n\n                                alert(_context.t0);\n\n                            case 11:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[0, 8]]);\n            }));\n\n            function getData(_x) {\n                return _ref.apply(this, arguments);\n            }\n\n            return getData;\n        }()\n    }, {\n        key: 'persistData',\n        value: function persistData() {\n            this.addUserDetail();\n            localStorage.setItem('userDetails', JSON.stringify(this.userDetails));\n        }\n    }, {\n        key: 'readStorage',\n        value: function readStorage() {\n            var _this = this;\n\n            var storage = JSON.parse(localStorage.getItem('userDetails'));\n            //Restoring likes from storage\n            if (storage) {\n                this.userDetails = storage;\n                this.userDetails.forEach(function (el) {\n                    if (_this.username === el.username) {\n                        _this.username = el.username;\n                        _this.likes = el.likes, _this.bookmarks = el.bookmarks;\n                    }\n                });\n            }\n        }\n    }]);\n\n    return booknlike;\n}();\n\nexports.default = booknlike;\n;\n\n//# sourceURL=webpack:///./src/js/models/booknlike.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n//http://www.omdbapi.com/?i=tt3896198&apikey=dbaf7dd7\n\nvar search = function () {\n    function search(moviename) {\n        _classCallCheck(this, search);\n\n        this.moviename = moviename;\n    }\n\n    _createClass(search, [{\n        key: 'getMovieDetails',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var res, movie;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.prev = 0;\n                                _context.next = 3;\n                                return (0, _axios2.default)('http://www.omdbapi.com/?t=' + this.moviename + '&plot=full&apikey=dbaf7dd7');\n\n                            case 3:\n                                res = _context.sent;\n\n                                // console.log(res);\n                                movie = res.data;\n                                return _context.abrupt('return', movie);\n\n                            case 8:\n                                _context.prev = 8;\n                                _context.t0 = _context['catch'](0);\n\n                                alert(_context.t0);\n\n                            case 11:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[0, 8]]);\n            }));\n\n            function getMovieDetails() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getMovieDetails;\n        }()\n    }, {\n        key: 'getMovieDetailsByFilters',\n        value: function () {\n            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n                var year = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'All';\n                var res, movie;\n                return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                    while (1) {\n                        switch (_context2.prev = _context2.next) {\n                            case 0:\n                                _context2.prev = 0;\n\n                                //http://www.omdbapi.com/?i=tt3896198&apikey=86774b92\n                                res = void 0;\n\n                                if (!(year === 'All' || year === 'select')) {\n                                    _context2.next = 8;\n                                    break;\n                                }\n\n                                _context2.next = 5;\n                                return (0, _axios2.default)('http://www.omdbapi.com/?s=' + this.moviename + '&apikey=86774b92');\n\n                            case 5:\n                                res = _context2.sent;\n                                _context2.next = 12;\n                                break;\n\n                            case 8:\n                                if (!(year !== 'All' && year !== 'select')) {\n                                    _context2.next = 12;\n                                    break;\n                                }\n\n                                _context2.next = 11;\n                                return (0, _axios2.default)('http://www.omdbapi.com/?s=' + this.moviename + '&t=' + year + '&apikey=86774b92');\n\n                            case 11:\n                                res = _context2.sent;\n\n                            case 12:\n                                // console.log(res);\n                                movie = res.data.Search;\n                                // console.log(movie);\n\n                                return _context2.abrupt('return', movie);\n\n                            case 16:\n                                _context2.prev = 16;\n                                _context2.t0 = _context2['catch'](0);\n\n                                alert(_context2.t0);\n\n                            case 19:\n                            case 'end':\n                                return _context2.stop();\n                        }\n                    }\n                }, _callee2, this, [[0, 16]]);\n            }));\n\n            function getMovieDetailsByFilters() {\n                return _ref2.apply(this, arguments);\n            }\n\n            return getMovieDetailsByFilters;\n        }()\n    }, {\n        key: 'getMovieDetailsById',\n        value: function () {\n            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(id) {\n                var res, movie;\n                return regeneratorRuntime.wrap(function _callee3$(_context3) {\n                    while (1) {\n                        switch (_context3.prev = _context3.next) {\n                            case 0:\n                                _context3.prev = 0;\n                                _context3.next = 3;\n                                return (0, _axios2.default)('http://www.omdbapi.com/?i=' + id + '&plot=full&apikey=dbaf7dd7');\n\n                            case 3:\n                                res = _context3.sent;\n\n                                // console.log(res);\n                                movie = res.data;\n                                return _context3.abrupt('return', movie);\n\n                            case 8:\n                                _context3.prev = 8;\n                                _context3.t0 = _context3['catch'](0);\n\n                                alert(_context3.t0);\n\n                            case 11:\n                            case 'end':\n                                return _context3.stop();\n                        }\n                    }\n                }, _callee3, this, [[0, 8]]);\n            }));\n\n            function getMovieDetailsById(_x2) {\n                return _ref3.apply(this, arguments);\n            }\n\n            return getMovieDetailsById;\n        }()\n    }]);\n\n    return search;\n}();\n\nexports.default = search;\n\n//# sourceURL=webpack:///./src/js/models/search.js?");

/***/ }),

/***/ "./src/js/models/signinnup.js":
/*!************************************!*\
  !*** ./src/js/models/signinnup.js ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderTop10 = exports.limitString = exports.clearResults = undefined;\n\nvar _base = __webpack_require__(/*! ../base */ \"./src/js/base.js\");\n\nvar _booknlike = __webpack_require__(/*! ../models/booknlike */ \"./src/js/models/booknlike.js\");\n\nvar _booknlike2 = _interopRequireDefault(_booknlike);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar clearResults = exports.clearResults = function clearResults() {\n  _base.elements.top10dis.innerHTML = '';\n  i = 0;\n};\n\nvar limitString = exports.limitString = function limitString(title) {\n  var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 115;\n\n  var newTitle = [];\n  if (title.length > limit) {\n    title = title.split(' ').reduce(function (acc, curr) {\n      if (acc + curr.length <= limit) {\n        newTitle.push(curr);\n      }\n      return acc + curr.length;\n    }, 0);\n    return newTitle.join(' ') + ' ...';\n  }\n  return title;\n};\n\nvar getRandomColor = function getRandomColor() {\n  var letters = '0123456789ABCDEF';\n  var color = '#';\n  for (var i = 0; i < 6; i++) {\n    color += letters[Math.floor(Math.random() * 16)];\n  }\n  return color;\n};\n\nvar i = 0;\n\nvar renderMovie = function renderMovie(movie) {\n  var sty = '';\n  if (localStorage.getItem('login') === 'false') {\n    sty = 'style=\"display:none\";';\n  }\n  var outlike = void 0,\n      outbook = void 0;\n  var user = localStorage.getItem('log');\n  var bnl = new _booknlike2.default(user);\n  bnl.readStorage();\n  if (bnl.isLiked(movie.id)) {\n    outlike = 'fas';\n  } else {\n    outlike = 'far';\n  }\n  if (bnl.isBookmarked(movie.id)) {\n    outbook = 'fas';\n  } else {\n    outbook = 'far';\n  }\n  var midGen = '';\n  movie.genres.split(',').forEach(function (el) {\n    midGen += '<div class=\"movie__tag movie__tag--' + el + '\" style=\"background-color:' + getRandomColor() + ';\">#' + el + '</div>';\n  });\n  var start = '<h2>Top10 movies right now  <a href=\"#\"><i class=\"far fa-times-circle\" id=\"top10Close\" style=\"color: #b10000;\"></i></a></h2>';\n  if (i === 0) {\n    _base.elements.top10dis.insertAdjacentHTML('afterbegin', start);i += 1;\n  };\n  var markup = '\\n    <section class=\"movies__details\" id=\"' + movie.id + '\">\\n    <figure class=\"movie\">\\n      <div class=\"movie__hero\">\\n        <img src=\"' + movie.poster + '\"\\n             alt=\"movie\" class=\"movie__img\">\\n      </div>\\n      <div class=\"movie__content\">\\n        <div class=\"movie__title\">\\n        <h1 class=\"movie__heading\">' + movie.title + '</h1>\\n        <a href=\"#\" class=\"bookmark\" ' + sty + '><i class=\"' + outbook + ' fa-bookmark\"></i></a>\\n        <!-- <i class=\"fas fa-bookmark\"></i> -->\\n        <a href=\"#\" class=\"liked\" ' + sty + '><i class=\"' + outlike + ' fa-heart\"></i></a> \\n        <!-- <i class=\"fas fa-heart\"></i> -->\\n      </div>\\n        <p class=\"movie__description\">' + limitString(movie.des) + '</p>\\n        <div class=\"tags\">\\n          <p>tags :</p>\\n          <div class=\"tags-add\">\\n            ' + midGen + '\\n            </div>\\n          </div>\\n        <div class=\"movie__details\">\\n          <p class=\"movie__detail\"><span class=\"emoji\">imdb</span>' + movie.rating + ' / 10</p>\\n          <p class=\"movie__detail\"><span class=\"emoji\">\\u23F1</span>' + movie.span + '</p>\\n        </div>\\n      </div>\\n    </figure>      \\n    </section>\\n    ';\n  _base.elements.top10dis.insertAdjacentHTML('beforeend', markup);\n};\n\nvar renderTop10 = exports.renderTop10 = function renderTop10(top10s) {\n  top10s.forEach(renderMovie);\n};\n\n//# sourceURL=webpack:///./src/js/views/top10view.js?");
